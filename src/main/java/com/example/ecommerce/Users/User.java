...
@SqlResultSetMapping(
    ...
    classes = @ConstructorResult(
        targetClass = UserAssignedRolesById.class,
        columns = {
...
@NamedNativeQuery(
    name = "User.findUserRolesByEmail",
    query = "SELECT Users.id AS user_id, Users.name AS user_name, Users.email AS user_email, Users_Role_Sync.role_id AS sync_role_id, User_Role.id AS role_id, User_Role.name AS role_name " +
            "FROM Users " +
    ...
    resultSetMapping = "UserRoleDTOMapping"
)
@Entity (name = "Users")
